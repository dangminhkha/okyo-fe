    ...
    <v-card>
      <v-card-text>
        <div class="bg-white p-4 rounded-lg">
          ...
          <v-form ref="form" v-model="valid" @submit.prevent="submitAddProduct" class="grid">
            <v-row>
              <v-col cols="12" md="6">
              ...
              <v-col cols="12" md="6">
                <v-select label="Loại sản phẩm" :items="typeList" v-model="typeSelected" variant="outlined"
            ...
            <v-row>
              ...
              <v-col cols="6" md="4"><v-checkbox v-model="outstanding" label="Nổi bật"></v-checkbox></v-col>
            </v-row>
            <span class="mdi mdi-plus cursor-pointer my-1 text-blue-darken-2" @click="detailCount++"><span
                class="font-bold">Đặc điểm nổi bật</span></span>
            <v-row no-gutters>
              <v-col cols="12" v-for="(item, index) in detailCount" :key="index">
                <v-text-field variant="outlined" :ref="'details' + index" v-model="noibat.details_id[index]"
                  prepend-inner-icon="mdi:mdi-close " @change="acceptAddDetail(noibat.details_id[index], index)"
                  @click:prepend-inner="
      ...
      <v-card-text>
        <div class="bg-white p-4 rounded-lg">
          ...
          <v-form ref="formEdit" v-model="valid" @submit.prevent="editConfirm" class="grid gap-3">
            ...
            <v-row>
              <v-col cols="6" md="4"><v-text-field type="number" inputmode="numeric" label="Thời hạn BH"
                  variant="outlined" v-model="monthGuarantee" :rules="rulesRequired">
                </v-text-field></v-col>
              <v-col cols="6" md="4"><v-checkbox v-model="status" label="Hoạt động"></v-checkbox></v-col>
              <v-col cols="6" md="4"><v-checkbox v-model="outstanding" label="Nổi bật"></v-checkbox></v-col>
            </v-row>
            <span class="mdi mdi-plus cursor-pointer my-1 text-blue-darken-2" @click="detailCount++"><span
                class="font-bold">Đặc điểm nổi bật</span></span>
