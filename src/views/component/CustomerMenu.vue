<template>
  ...
  <div
    ...
    class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform w-[260px] h-full fixed inset-y-0 start-0 z-[60] bg-white border-e border-gray-200 block lg:hidden lg:translate-x-0 lg:end-auto lg:bottom-0 dark:bg-neutral-800 dark:border-neutral-700"
    role="dialog"
    tabindex="-1"
    aria-label="Sidebar"
  >
            ...
            <li class="hs-accordion" id="account-accordion">
              ...
              >
                <ul class="ps-8 pt-1 space-y-1">
                  <li
                    v-for="(item, index) in getListTypeData.data"
                    :key="index"
                  >
                    <a
